...
\echo
-- hypertable has it's own size stuffs!
select pg_size_pretty(hypertable_size('iot_giant'::regclass)) as total_size;
select pg_size_pretty(hypertable_index_size('iot_giant'::regclass)) as index_size;
-- \df hypertable_size
